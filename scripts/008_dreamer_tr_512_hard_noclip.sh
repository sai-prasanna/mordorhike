...
if [ $SLURM_ARRAY_TASK_ID -eq 0 ]; then
    ...
    #uv run eval-dreamer --logdir $logdir --metric_dir "eval_post_mode" --wandb.group "008_dreamer_tr_512_hard_noclip_post_mode" --wandb.name "42_eval" --policy_mode "eval"
    ...
    uv run eval-dreamer --logdir $logdir
    #uv run eval-dreamer --logdir $logdir --metric_dir "eval_post_mode" --wandb.group "008_dreamer_tr_512_hard_noclip_post_mode" --wandb.name "1337_eval" --policy_mode "eval"
    ...
    uv run eval-dreamer --logdir $logdir
    #uv run eval-dreamer --logdir $logdir --metric_dir "eval_post_mode" --wandb.group "008_dreamer_tr_512_hard_noclip_post_mode" --wandb.name "13_eval" --policy_mode "eval"
fi  
end=`date +%s`
