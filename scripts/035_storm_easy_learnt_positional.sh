...
#SBATCH --job-name 035_storm_easy_learnt_positional
...
uv run train-storm --logdir $logdir --seed $seed --env.name "mordor-hike-easy-v0" --world_model.transformer_positional_encoding learnt
