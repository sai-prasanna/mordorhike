...
#SBATCH --job-name 045_drqn_hard_tuned_gradient_steps_high
...
uv run train-drqn --logdir $logdir --configs defaults --seed $seed --env.name "mordor-hike-hard-v0" --train.batch_size 126 --train.epsilon 0.2389 --drqn.hidden_size 160 --train.learning_rate 0.00022516182798426598 --train.num_gradient_steps 100 --train.train_every 35 --train.target_period 280
