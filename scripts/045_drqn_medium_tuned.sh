...
#SBATCH --job-name 045_drqn_medium_tuned
...
uv run train-drqn --logdir $logdir --configs defaults --seed $seed --env.name "mordor-hike-medium-v0" --train.batch_size 126 --train.epsilon 0.2389 --drqn.hidden_size 160 --train.learning_rate 0.00022516182798426598 --train.num_gradient_steps 13 --train.train_every 35 --train.target_period 280
