...
#SBATCH --job-name 007_dreamer_tr_512_hard
...
if [ $SLURM_ARRAY_TASK_ID -eq 0 ]; then
    logdir="experiments/mordor_hike/007_dreamer_tr_512_hard/42"
    ...
    uv run eval-dreamer --logdir $logdir --task mordorhike_hard
elif [ $SLURM_ARRAY_TASK_ID -eq 1 ]; then
    logdir="experiments/mordor_hike/007_dreamer_tr_512_hard/1337"
    ...
    logdir="experiments/mordor_hike/007_dreamer_tr_512_hard/13"
