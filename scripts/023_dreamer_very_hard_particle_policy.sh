...
#SBATCH --job-name 023_dreamer_very_hard_particle_policy
...
uv run train-dreamer --logdir $logdir --configs mordorhike --seed $seed --task gymnasium_mordor-hike-veryhard-v0 --n_particles 10 --particle_policy True
end=`date +%s`
