...
#SBATCH --job-name 038_drqn_medium_even_faster_update
...
uv run train-drqn --logdir $logdir --configs defaults --seed $seed --env.name "mordor-hike-medium-v0" --train.train_every 20 --train.target_period 200
