...
#SBATCH --job-name 044_dreamer_hard_tuned
...
uv run train-dreamer --logdir $logdir --configs mordorhike --seed $seed --task "gymnasium_mordor-hike-hard-v0" --batch_size 8 --dyn.rssm.deter 256 --dyn.rssm.hidden 85 --dyn.rssm.classes 11 --opt.lr 0.00023854151368141174 --run.train_ratio 262 --.*\\.units 165
